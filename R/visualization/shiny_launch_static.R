...
#runApp(here('results'),port=strtoi(Sys.getenv(c("SHINY_PORT"))))
runApp(here('app_dir'),port=strtoi(Sys.getenv(c("SHINY_PORT"))))
#runApp(here('R/visualization'),port=strtoi(Sys.getenv(c("SHINY_PORT"))))
