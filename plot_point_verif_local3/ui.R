...
# setwd('/perm/sp3c/deode_verif/plot_point_verif_local')
# library(here)
# library(shiny)
...
ui <- pageWithSidebar(
  headerPanel(
    title = a("Monitor-like HARP's visualization tool (click for more case studies)", href="https://svianaj.shinyapps.io/plot_point_verif_local2")
),
