...
server <- function(input, output, session) {
  ...
  basedir <- as.character(normalizePath(file.path(paste0(here(),'/app_dir/cases/'))))
  #basedir <- as.character(normalizePath(file.path(paste0(here(),'/ec/res4/scratch/nhd/verification/plots/DANRA/2022100106-2022123018'))))
  #basedir <- '/ec/res4/scratch/nhd/verification/plots/DANRA/2022100106-2022123018'
  #print("here")
